<x-app-layout>
    ...
    <div class="py-8 px-6 bg-gray-100 min-h-screen">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
             ...
             <div class="bg-indigo-600 text-white rounded-xl p-6 shadow-lg"><h3 class="text-lg">Reservas</h3><p class="text-3xl font-bold">{{ $totalReservas ?? 'N/A' }}</p></div>
             <div class="bg-indigo-600 text-white rounded-xl p-6 shadow-lg"><h3 class="text-lg">Pagos</h3><p class="text-3xl font-bold">${{ $totalPagos ?? 'N/A' }}</p></div>
             <div class="bg-indigo-600 text-white rounded-xl p-6 shadow-lg"><h3 class="text-lg">Eventos</h3><p class="text-3xl font-bold">{{ $totalEventos ?? 'N/A' }}</p></div>
        </div>
